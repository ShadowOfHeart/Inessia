package gg.vape.helpers.render;
...
public class ShaderUtil {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                case "roundedRectGradient":
                    ...
                    break;
                default:
                    fragmentShaderID = createShader(RenderUtil.mc.getResourceManager().getResource(new ResourceLocation(fragmentShaderLoc)).getInputStream(), GL_FRAGMENT_SHADER);
                    break;
            }
            glAttachShader(program, fragmentShaderID);

            int vertexShaderID = createShader(RenderUtil.mc.getResourceManager().getResource(new ResourceLocation(vertexShaderLoc)).getInputStream(), GL_VERTEX_SHADER);
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "vapegg/shaders/vertex.vsh");
    }
