...
public class RoundedUtil {
    ...
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("vapegg/shaders/outline.frag");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("vapegg/shaders/round.frag");
