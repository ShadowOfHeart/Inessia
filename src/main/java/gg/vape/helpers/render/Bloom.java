...
public class Bloom {
    ...
    public static ShaderUtil gaussianBloom = new ShaderUtil("vapegg/shaders/bloom.frag");
    ...
    public static void setupUniforms(float radius, float directionX, float directionY, FloatBuffer weights, Color color) {
        ...
        gaussianBloom.setUniformf("texelSize", 1.0F / (float) RenderUtil.mc.displayWidth, 1.0F / (float) RenderUtil.mc.displayHeight);
