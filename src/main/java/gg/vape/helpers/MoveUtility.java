...
public class MoveUtility extends Utils {
...
//    }
    ...
    public static void setEventSpeed(EventMotion move, float speed) {
        ...
        move.setPosX((forward * speed * Math.cos(Math.toRadians(yaw + 90))
                + strafe * speed * Math.sin(Math.toRadians(yaw + 90))));
        move.setPosZ((forward * speed * Math.sin(Math.toRadians(yaw + 90))
