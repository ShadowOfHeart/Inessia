...
import static net.minecraft.client.gui.GuiMainMenu.altM;
...
public class GuiClientTextField extends Gui {
    ...
    public boolean mouseClicked(int mouseX, int mouseY, int mouseButton) {
        final ScaledResolution sr = new ScaledResolution(Helper.mc);
        animation2.setDirection((altM ? Direction.FORWARDS : Direction.BACKWARDS));
        //              (animation2.getOutput() * 15)
        boolean flag = mouseX >= 20 - 200 + (animation2.getOutput() * 200) && mouseX < 20 - 200 + (animation2.getOutput() * 200) + 130 && mouseY >= 10 && mouseY < 10 + 20;
        if (this.canLoseFocus) {
            this.setFocused(flag);
        }

        if (this.isFocused && flag && mouseButton == 0) {
            int i = (int) (mouseX - 20 - 200 + (animation2.getOutput() * 200));
    ...
    public void drawTextBox() {
        ...
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RoundedUtil.drawRound((float) (20 - 200 + (animation2.getOutput() * 200)),10,  130, 20.0f, 2.0F, new Color(0, 0, 0, 100));
            }
            ...
            int l = this.enableBackgroundDrawing ? (int) (35 - 200 + (animation2.getOutput() * 200) + 4) : (int) (35 - 200 + (animation2.getOutput() * 200));
            int i1 = this.enableBackgroundDrawing ? 10 + (20 - 8) / 2 : 10;
            int j1 = l;
            if (k > s.length()) {
                k = s.length();
            }
            ...
            if (!s.isEmpty()) {
                ...
                j1 = (int) Fonts.BOLD16.drawString(s1, (float)l - 15 - 200 + (animation2.getOutput() * 200), (float)i1 + 2.0F, i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                int var10000 = (int)Fonts.BOLD16.drawString(s.substring(j), (float)j1 + 2.0F, (float)i1 + 2.0F, i);
            }

            if (flag1 && !flag2) {
                Fonts.BOLD16.drawString("", (float)k1 + 2.0F, (float)i1 + 2.0F, i);
            }

            if (k != j) {
                int l1 = l + Fonts.BOLD16.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + Fonts.BOLD16.getFontHeight());
            }
        }
