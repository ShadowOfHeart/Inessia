...
public class MovementUtils implements Helper {
    ...
    public static boolean airBlockAbove2() {
        return !mc.world.checkBlockCollision(mc.player.getEntityBoundingBox().contract(0.0, mc.player.onGround ? 0.3 : 0.0, 0.0));
    }
...
//    }
    ...
    public static void strafeqq() {
        MovementUtils.strafe(MovementUtils.getSpeedqq());

    }
    public static float getSpeed() {
        return (float) Math.sqrt(mc.player.motionX * mc.player.motionX + mc.player.motionZ * mc.player.motionZ);
    }
    public static float getSpeedqq() {
        return (float) Math.sqrt(mc.player.motionX * mc.player.motionX + mc.player.motionZ * mc.player.motionZ + mc.player.motionZ * mc.player.motionZ);
    }
