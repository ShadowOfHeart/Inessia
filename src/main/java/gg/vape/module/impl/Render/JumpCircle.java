...
import gg.vape.event.events.impl.JumpEvent;
...
public class JumpCircle extends Module {
    ...
    public ModeSetting mode = new ModeSetting("Мод", "Akrien", "Celestial", "Akrien").call(this);
    public SliderSetting speed = new SliderSetting("Скорость", 1, 0, 10, 1).call(this);
