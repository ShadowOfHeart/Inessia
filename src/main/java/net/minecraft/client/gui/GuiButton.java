...
//            RenderUtil.blur(() -> {
//                RoundedUtil.drawRound(x, y, width, height, 3, new Color(0, 0, 0, 0));
//            }, 0);
            RoundedUtil.drawRound(x, y, width, height, 3, new Color(20, 20, 20, 150));
//            if (animation.getOutput() > 0) {
//                RenderUtil.drawBlurredShadow((float) (x + width / 2) - (float) (width / 2 * animation.getOutput()), y, (float) (width * animation.getOutput()), height, 10, new Color(255, 255, 255, 48));
//                RoundedUtil.drawGradientHorizontal((float) (x + width / 2) - (float) (width / 2 * animation.getOutput()), y, (float) (width * animation.getOutput()), height, 3, new Color(0, 0, 0, 255), new Color(ClickGui.getColor()));
//            }
//            animation.setDirection(hovered ? Direction.FORWARDS : Direction.BACKWARDS);
//            animation.setDuration(300);
            this.mouseDragged(mc, mouseX, mouseY);
            Fonts.BOLD16.drawCenteredString(this.displayString, this.x + this.width / 2f, this.y + (this.height - 5) / 2f, -1);
        }
    }
