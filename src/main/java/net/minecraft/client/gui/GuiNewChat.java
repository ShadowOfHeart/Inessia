...
import gg.vape.command.impl.CrashCommand;
import gg.vape.event.EventManager;
import gg.vape.event.events.impl.ChatEvent;
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                if (l1 / 2f < 100) {
                                    chatline.animXX = gg.vape.helpers.math.MathHelper.interpolate(-chatline.animX, chatline.animXX, 0.1);
                                } else
                                    chatline.animXX = gg.vape.helpers.math.MathHelper.interpolate(chatline.animX, chatline.animXX, 0.1);
                                int i2 = 0;
                                double j2 = -i1 * 9;
