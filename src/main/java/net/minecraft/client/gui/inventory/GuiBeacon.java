...
import gg.vape.module.impl.Misc.BeaconExploit;
        ...
        if (this.buttonsNotDrawn && i >= 0)
        {
            ...
            for (int k = 0; k <= 2; ++k)
            {
                ...
                for (int j1 = 0; j1 < l; ++j1)
                {
                    ...
                    if (k >= i)
                    {
                        guibeacon$powerbutton.enabled = Medusa.m.getModule(BeaconExploit.class).state;
                    }
            ...
            for (int j2 = 0; j2 < l1 - 1; ++j2)
            {
                ...
                if (3 >= i)
                {
                    guibeacon$powerbutton2.enabled = Medusa.m.getModule(BeaconExploit.class).state;
                }
            ...
            if (potion != null)
            {
                ...
                if (3 >= i)
                {
                    guibeacon$powerbutton1.enabled = Medusa.m.getModule(BeaconExploit.class).state;
                }
