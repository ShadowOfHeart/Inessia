    ...
    public void handleBlockChange(SPacketBlockChange packetIn)
    {
        ...
        try {
            if (this.world.getBlockState(packetIn.getBlockPosition()).getBlock() == Blocks.AIR
                ...
                if (baritone.getMineProcess().isActive() && baritone.getMineProcess() instanceof MineProcess && (Medusa.m.getModule(gg.vape.module.impl.Player.Baritone.class).state && ((gg.vape.module.impl.Player.Baritone) Medusa.m.getModule(Baritone.class)).antirg.get())) {
