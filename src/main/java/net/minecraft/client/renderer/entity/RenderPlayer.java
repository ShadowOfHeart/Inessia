...
import gg.vape.module.impl.Player.Optimizer;
import gg.vape.module.impl.Render.Chams;
...
public class RenderPlayer extends RenderLivingBase<AbstractClientPlayer>
{
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        {
            if (RenderUtil.isInViewFrustrum(entity) && Medusa.m.getModule("Optimizer").state && ((Optimizer) Medusa.m.getModule("Optimizer")).entities.get()) {
                double d0 = y;
                ...
                if (Medusa.m.getModule(Chams.class).state) {
            ...
            } else if (!Medusa.m.getModule("Optimizer").state) {
                double d0 = y;
                ...
                if (Medusa.m.getModule(Chams.class).state) {
                    ...
                    super.doRender(entity, x, d0, z, entityYaw, partialTicks);
                GlStateManager.disableBlendProfile(GlStateManager.Profile.PLAYER_SKIN);
            } else if (!((Optimizer) Medusa.m.getModule("Optimizer")).entities.get()){
                double d0 = y;
