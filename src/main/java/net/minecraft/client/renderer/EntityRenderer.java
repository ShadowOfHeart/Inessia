...
import gg.vape.module.impl.Render.CameraClip;
        ...
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (!Medusa.m.getModule(CameraClip.class).state) {
...
//                    if (Vape.m.getModule(WorldColor.class).state) {
//                        int j = 255;
//                        int k = new Color(ClickGui.color.get()).getRed();
//                        int l = new Color(ClickGui.color.get()).getGreen();
//                        int i1 = new Color(ClickGui.color.get()).getBlue();
...
//        if (Vape.m.getModule(FogColor.class).state) {
//            Color rgb = new Color(((FogColor) Vape.m.getModule(FogColor.class)).fogColor.color);
